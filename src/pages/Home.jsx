    ...
    <div className="space-y-12">
      ...
      <div className="text-center max-w-3xl mx-auto mb-8">
        <p className="text-gray-700 leading-relaxed">
          投資における「リスク」とは、「危険」という意味ではなく、<br/>
          <strong>「振れ幅（リターンがどれくらいブレるか）」</strong>のことです。<br/>
          あらかじめ「最大でどれくらい下がる可能性があるか」を想定できていると、実際にそれが起きた時も冷静に対処できます。
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-xl border-l-4 border-red-500 shadow-sm">
          ...
          <div className="bg-red-50 p-4 rounded-lg mb-4">
             <div className="flex justify-between items-center border-b border-red-200 pb-2 mb-2">
               <span className="text-xs font-bold text-red-800">過去の最大級の暴落（リーマンショック等）</span>
               <span className="text-lg font-bold text-red-600">-50% 前後</span>
             </div>
             <p className="text-xs text-red-700">
               1000万円が、一時的に500万円になる可能性があります。<br/>
        ...
        <div className="bg-white p-6 rounded-xl border-l-4 border-yellow-500 shadow-sm">
          ...
          <ul className="text-sm text-gray-600 space-y-2 list-disc list-inside bg-gray-50 p-3 rounded">
        ...
        {/* 4. インフレリスク（持たざるリスク） */}
        <div className="bg-white p-6 rounded-xl border-l-4 border-gray-500 shadow-sm">
          <h4 className="font-bold text-gray-800 mb-3 flex items-center text-lg">
          ...
          <div className="bg-gray-100 p-3 rounded text-center mb-2">
            ...
            <span className="font-bold text-gray-700">20年後、現金の価値は約67%に下落</span>
          </div>
          <p className="text-xs text-gray-500">
      ...
      {/* 結論：リスク許容度 */}
      <div className="bg-indigo-900 text-white p-8 rounded-2xl shadow-lg mt-8 text-center">
        <h3 className="text-2xl font-bold mb-4">結局、どうすればいいのか？</h3>
        <p className="text-indigo-100 mb-6 leading-relaxed">
          未来を予測することは誰にもできません。<br/>
          唯一の対策は、<strong>「最悪（資産が半分になること）を想定し、許容できる金額の範囲内で投資すること」</strong>です。
        </p>
        <div className="inline-block bg-white/10 backdrop-blur border border-white/20 px-8 py-4 rounded-xl">
          <p className="font-bold text-lg text-yellow-400 mb-2">鉄の掟：生活防衛資金を守る</p>
          <p className="text-sm text-indigo-200">
            生活費の6ヶ月〜1年分は必ず「現金」で確保する。<br/>
            暴落時に生活費のために株を売ることほど、悲惨なことはありません。<br/>
...
const ActionSection = () => (
  <Section id="step6" title="Chapter 6: 最強の武器と実践" subtitle="NISA（ニーサ）を正しく理解し、最初の行動を起こす" icon={ShieldCheck} className="bg-gradient-to-b from-indigo-50 to-white">
    <div className="space-y-16 max-w-4xl mx-auto">
      ...
      {/* 1. NISAの定義（修正：正式名称と信頼性） */}
      <div className="bg-white p-6 md:p-8 rounded-2xl border border-indigo-100 shadow-sm">
        <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
          <span className="bg-indigo-100 p-2 rounded-full text-indigo-600 mr-3"><Landmark size={24}/></span>
          NISA（ニーサ）とは？
        </h3>
        <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
          <p className="font-bold text-gray-800 mb-2">Nippon Individual Savings Account（少額投資非課税制度）</p>
          <p className="text-sm text-gray-700 leading-relaxed">
            これは特定の怪しい投資商品などではなく、国が国民の資産形成を支援するために作った<strong>「税金がかからない特別な口座（非課税口座）」</strong>のことです。<br/>
            通常、投資で得た利益には税金がかかりますが、この口座内で取引した利益に関しては、国が「税金を取らない」と定めています。
          </p>
        </div>
      </div>

      {/* 2. Action 01: 口座開設（図解修正：高さ統一・重なり解消・TAX強調版） */}
      <div>
        {/* 統一ヘッダースタイル Action 01 */}
        <div className="flex items-center mb-8">
          <div className="bg-indigo-600 text-white font-bold px-4 py-1 rounded-full mr-4 shadow-sm">Action 01</div>
          <h3 className="text-2xl font-bold text-gray-900">証券口座を開設する</h3>
        </div>
        
        <p className="text-gray-600 mb-8">
          銀行口座とは別に、株式を売買するための「証券口座」が必要です。<br/>
          ここで<span className="font-bold text-indigo-600">NISA口座</span>を選ぶことで、将来手元に残る金額が大きく変わります。
        </p>

        {/* グラフエリア */}
        <div className="flex flex-row justify-center gap-6 md:gap-16 items-end max-w-3xl mx-auto pb-8 pt-4">
          
          {/* A. 特定口座（課税） */}
          <div className="w-1/2 max-w-[220px] flex flex-col justify-end group">
             
             {/* タイトルエリア（高さをNISA側と合わせるためのスペーサー含む） */}
             <div className="mb-4 flex flex-col items-center justify-end h-20">
               <p className="text-center font-bold text-gray-500 text-sm md:text-base">
                 通常の口座<br/><span className="text-xs font-normal">(特定口座)</span>
               </p>
             </div>
             ...
             <div className="w-full flex flex-col items-center">
               ...
               <div className="w-full h-32 flex flex-col relative">
                  ...
                  {/* 残った利益（手取り） */}
                  <div className="w-full h-[80%] bg-gray-200 border-x border-gray-300 flex items-center justify-center text-gray-500 font-bold text-sm relative z-10 shadow-sm">
                    <div className="text-center">
                      <span className="text-xs block text-gray-400">手取り</span>
                      <span className="text-sm md:text-base text-gray-600">約80%</span>
                    </div>
                  </div>
               ...
               <div className="w-full h-32 bg-slate-500 rounded-b-xl flex items-center justify-center text-white font-bold shadow-lg z-20 border-t border-slate-400">
                 <span className="text-sm md:text-lg tracking-widest">投資元本</span>
               </div>
          ...
          <div className="w-1/2 max-w-[220px] flex flex-col justify-end relative transform md:scale-105 transition-transform duration-500">
             ...
             {/* タイトルエリア（バッジ＋タイトル） */}
             <div className="mb-4 flex flex-col items-center justify-end h-20">
                <span className="bg-yellow-400 text-yellow-900 text-[10px] md:text-xs font-bold px-3 py-1 rounded-full shadow-md whitespace-nowrap mb-2 animate-bounce">
                  これを使わないと損
                </span>
                <p className="text-center font-bold text-indigo-700 text-sm md:text-base">
                  NISA口座<br/><span className="text-xs font-normal">(非課税)</span>
                </p>
             </div>
             ...
             <div className="w-full flex flex-col items-center shadow-2xl rounded-xl">
               ...
               {/* 利益部分 (100% - 特定口座のTAX+手取りと同じ高さ h-32) */}
               <div className="w-full h-32 bg-gradient-to-b from-yellow-300 to-orange-400 rounded-t-xl flex flex-col items-center justify-center text-yellow-900 font-bold border border-yellow-500/30 z-10 relative overflow-hidden">
                 ...
                 <span className="text-lg md:text-2xl drop-shadow-sm">利益</span>
                 <span className="text-xs md:text-sm bg-white/20 px-3 py-0.5 rounded-full mt-1 border border-white/30">まるごと受取</span>
               </div>
        ...
        <p className="text-center text-xs text-gray-500 mt-2 pb-4">※イメージ図です。実際の税額は利益に対して20.315%となります。</p>
      </div>

      {/* 3. NISAのスペック表 */}
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
        <div className="bg-gray-50 p-4 border-b border-gray-200">
          <h4 className="font-bold text-gray-800 text-center">現在のNISA制度（新NISA）の仕組み</h4>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="text-xs text-gray-700 uppercase bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="px-4 py-3 w-1/4">項目</th>
                <th className="px-4 py-3 text-indigo-700 w-1/3 bg-indigo-50">つみたて投資枠</th>
                <th className="px-4 py-3 text-emerald-700 w-1/3 bg-emerald-50">成長投資枠</th>
              </tr>
            </thead>
            <tbody>
              <tr className="bg-white border-b border-gray-100">
                <td className="px-4 py-4 font-bold text-gray-900">年間投資上限</td>
                <td className="px-4 py-4 font-bold text-indigo-600">120万円 / 年</td>
                <td className="px-4 py-4 font-bold text-emerald-600">240万円 / 年</td>
              </tr>
              <tr className="bg-white border-b border-gray-100">
                <td className="px-4 py-4 font-bold text-gray-900">対象商品</td>
                <td className="px-4 py-4 text-gray-600">金融庁が厳選した<br/>長期積立向きの投信<br/><span className="text-xs text-indigo-500">（インデックスファンド等）</span></td>
                <td className="px-4 py-4 text-gray-600">投資信託に加え、<br/>個別株も購入可能</td>
              </tr>
              <tr className="bg-gray-50/50">
                <td className="px-4 py-4 font-bold text-gray-900">併用</td>
                <td className="px-4 py-4 text-center font-bold text-gray-700" colSpan="2">
                  可能（合計で年間 <span className="text-lg">360万円</span> まで投資可能）
                </td>
              </tr>
            </tbody>
          </table>
        </div>
        <div className="p-4 bg-yellow-50 text-xs text-gray-700 border-t border-yellow-100">
      ...
      {/* 4. Action 02: 積立設定（デザイン統一） */}
      <div>
         {/* 統一ヘッダースタイル Action 02 */}
        <div className="flex items-center mb-8">
          <div className="bg-indigo-600 text-white font-bold px-4 py-1 rounded-full mr-4 shadow-sm">Action 02</div>
          <h3 className="text-2xl font-bold text-gray-900">購入設定（積立）をする</h3>
        </div>

        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col">
             <h4 className="font-bold text-gray-800 mb-4 border-b pb-2">設定の流れ</h4>
          ...
          <div className="bg-green-50 p-6 rounded-xl border border-green-100 shadow-sm">
             <h4 className="font-bold text-green-900 mb-4 flex items-center"><Unlock className="mr-2" size={20}/>柔軟なルール</h4>
             ...
             <div className="bg-white/60 p-3 rounded text-xs text-green-800 border border-green-200">
               ...
               売却しても、その年に使った「年間非課税枠（最大360万）」は戻ってきません。（翌年になれば、売却した元本分の枠が復活します）
             </div>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-gray-200 pt-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl border-2 border-indigo-100 overflow-hidden max-w-3xl mx-auto transform transition hover:shadow-2xl">
            <div className="bg-gradient-to-r from-slate-50 to-indigo-50 p-4 border-b border-indigo-100 flex justify-between items-center">
                <span className="font-bold text-indigo-900 flex items-center"><Award className="mr-2 text-yellow-500"/>Recommended</span>
                <div className="text-xs text-gray-500">ネット証券口座開設数 No.1</div>
            </div>
            <div className="p-8 md:p-10 text-center">
                <div className="grid grid-cols-3 gap-2 mb-8 text-sm">
                    <div className="flex flex-col items-center p-2">
                        <div className="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center mb-2 text-indigo-600"><Coins size={24}/></div>
                    ...
                    <div className="flex flex-col items-center p-2 border-l border-r border-gray-100">
                        <div className="w-12 h-12 bg-yellow-100 rounded-full flex items-center justify-center mb-2 text-yellow-600"><Sparkles size={24}/></div>
                        <span className="font-bold text-gray-700 block">ポイント</span>
                        <span className="text-xs text-gray-500 mt-1">Vポイント等が貯まる</span>
                    </div>
                    <div className="flex flex-col items-center p-2">
                        <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mb-2 text-green-600"><CheckCircle size={24}/></div>
                        <span className="font-bold text-gray-700 block">銘柄数</span>
                        <span className="text-xs text-gray-500 mt-1">業界最高水準</span>
                    </div>
                </div>
                ...
                <p className="mt-6 text-xs text-gray-400 leading-relaxed">
                    本サイトはアフィリエイトプログラムを利用して商品を紹介しています。<br/>
...
const CompoundInterestVisualizer = () => {
  return (
    <div className="bg-gradient-to-br from-slate-50 to-indigo-50 p-6 rounded-xl border border-indigo-100 my-6">
      <h5 className="text-center font-bold text-gray-800 mb-2">1000万円を年利5%で運用した場合の比較</h5>
      <p className="text-center text-sm text-gray-500 mb-8">時間が経つほど、その差は圧倒的に開きます</p>
      
      <div className="grid grid-cols-2 gap-4 md:gap-8">
        {/* 単利の世界 */}
        <div className="flex flex-col items-center space-y-2 border-r border-gray-200 pr-4">
          <div className="text-sm font-bold text-gray-500 bg-gray-200 px-3 py-1 rounded-full mb-2">単利（貯金など）</div>
          <div className="space-y-4 w-full">
            <div className="flex justify-between items-center text-sm p-2 bg-white rounded border border-gray-100">
              <span className="text-gray-500 text-xs">1年目</span>
              <span className="font-mono">1050万</span>
            </div>
            <div className="flex flex-col items-center text-gray-300"><ArrowDown size={16} /></div>
            <div className="flex justify-between items-center text-sm p-2 bg-white rounded border border-gray-100">
              <span className="text-gray-500 text-xs">10年目</span>
              <span className="font-mono">1500万</span>
            </div>
            <div className="flex flex-col items-center text-gray-300"><ArrowDown size={16} /></div>
            <div className="flex justify-between items-center font-bold text-gray-700 bg-gray-200 p-3 rounded shadow-sm">
              <span className="text-xs">30年目</span>
              <span className="font-mono text-lg">2500万</span>
            </div>
          </div>
          <div className="text-xs text-gray-500 mt-2 text-center">毎年+50万</div>
        </div>

        {/* 複利の世界 */}
        <div className="flex flex-col items-center space-y-2 pl-4">
          <div className="text-sm font-bold text-white bg-indigo-500 px-3 py-1 rounded-full shadow-md mb-2">複利（投資）</div>
          <div className="space-y-4 w-full">
            <div className="flex justify-between items-center text-sm p-2 bg-indigo-50 rounded border border-indigo-100 text-indigo-900">
              <span className="text-indigo-400 text-xs">1年目</span>
              <span className="font-mono">1050万</span>
            </div>
            <div className="flex flex-col items-center text-indigo-300"><ArrowDown size={16} /></div>
            <div className="flex justify-between items-center text-sm p-2 bg-indigo-50 rounded border border-indigo-100 text-indigo-900">
              <span className="text-indigo-400 text-xs">10年目</span>
              <span className="font-mono font-bold">1629万</span>
            </div>
            <div className="flex flex-col items-center text-indigo-400 font-bold"><ArrowDown size={24} /></div>
            <div className="flex justify-between items-center font-bold text-white bg-indigo-600 p-3 rounded shadow-lg transform scale-105">
              <span className="text-xs">30年目</span>
              <span className="font-mono text-lg">4321万</span>
            </div>
          </div>
          <div className="text-xs text-indigo-600 mt-2 text-center font-bold">加速して増える！</div>
        </div>
      </div>
      <p className="text-center text-xs text-indigo-500 mt-6 font-bold">
        30年後の差額：<span className="text-lg mx-1 text-red-500">1821万円</span>
      </p>
    </div>
  );
};
...
const HabitSimulator = () => {
  ...
  return (
    <div className="bg-white p-6 md:p-8 rounded-2xl border-2 border-indigo-100 shadow-lg my-10">
      <div className="text-center mb-8">
      ...
      {/* 結果表示エリア */}
      <div className="bg-gradient-to-br from-slate-800 to-indigo-900 rounded-2xl p-6 text-white relative overflow-hidden">
        {/* 背景装飾 */}
        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-4">
            <div>
              <p className="text-indigo-200 text-xs font-bold tracking-widest mb-1">SELECTED HABIT</p>
              <div className="flex items-center gap-3">
                 ...
                 <div>
                   <h4 className="text-xl font-bold">{habits[selectedHabit].label}</h4>
                   <p className="text-sm text-indigo-200">
            ...
            <div className="bg-white/10 rounded-lg p-4 border border-white/10">
               <div className="flex justify-between items-center mb-1">
                 <span className="text-sm text-indigo-200">月間の出費</span>
                 <span className="font-mono font-bold text-lg">{result.monthly.toLocaleString()}円</span>
               </div>
               <div className="flex justify-between items-center text-xs text-indigo-300 border-t border-white/10 pt-2 mt-2">
                 <span>30年間の総出費</span>
          ...
          <div className="text-center md:text-right">
             <p className="text-indigo-200 text-sm mb-2">これを年利5%で運用していたら...</p>
             <div className="inline-block">
               <span className="text-5xl md:text-6xl font-bold text-yellow-400 tracking-tighter">
                 {result.total}
               </span>
               <span className="text-xl font-bold ml-2">万円</span>
             </div>
...
const DcaVisualizer = () => (
  <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 my-6">
    <h5 className="text-center font-bold text-gray-800 mb-6">毎月千円分「リンゴ」を買うとしたら？</h5>
    <div className="flex flex-col md:flex-row justify-around items-center gap-8">
      <div className="text-center w-full">
        <div className="bg-red-100 text-red-800 px-3 py-1 rounded-full text-xs font-bold inline-block mb-2">値段が高い月</div>
        <div className="text-gray-500 text-sm mb-2">1個 500円</div>
        <div className="bg-white rounded-lg border-2 border-dashed border-gray-300 p-4 flex justify-center gap-1">
          {[...Array(2)].map((_, i) => <div key={i} className="w-6 h-6 bg-red-400 rounded-full shadow-sm"></div>)}
        </div>
        <p className="mt-2 font-bold text-gray-700">2個しか買えない</p>
        <p className="text-xs text-gray-500">（高値掴みを防止）</p>
      </div>
      <div className="hidden md:block text-gray-400"><ArrowRight size={32} /></div>
      <div className="text-center w-full">
        <div className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-xs font-bold inline-block mb-2">値段が安い月（暴落）</div>
        <div className="text-gray-500 text-sm mb-2">1個 250円</div>
        <div className="bg-white rounded-lg border-2 border-blue-200 p-4 flex justify-center gap-1">
          {[...Array(4)].map((_, i) => <div key={i} className="w-6 h-6 bg-red-500 rounded-full shadow-sm"></div>)}
        </div>
        <p className="mt-2 font-bold text-blue-600">4個も買える！</p>
        <p className="text-xs text-gray-500">（安く大量に仕込める）</p>
      </div>
    </div>
  </div>
);
...
const MutualFundVisualizer = () => (
  <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 my-6 text-center">
    <h5 className="text-center font-bold text-gray-800 mb-6">投資信託（ファンド）の仕組み</h5>
    <div className="relative max-w-md mx-auto">
      <div className="flex justify-between px-4 mb-2">
        {[1, 2, 3].map((i) => (
          <div key={i} className="flex flex-col items-center">
            <div className="bg-white p-2 rounded-full border border-gray-200 shadow-sm"><User size={20} className="text-gray-500"/></div>
            <ArrowDown size={16} className="text-indigo-300 mt-1"/>
          </div>
        ))}
      </div>
      <div className="bg-white border-2 border-indigo-200 rounded-xl p-6 relative z-10 shadow-lg mb-4">
        <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-indigo-600 text-white px-4 py-1 rounded-full text-xs font-bold">ファンド（大きな財布）</div>
        <Building2 className="mx-auto text-indigo-400 mb-2" size={40} />
        <p className="text-xs text-gray-500">プロが運用・管理</p>
      </div>
      <ArrowDown size={24} className="mx-auto text-indigo-400 mb-2"/>
      <div className="grid grid-cols-3 gap-2">
        {['Apple', 'Toyota', 'Amazon'].map((name, i) => (
          <div key={i} className="bg-green-50 p-2 rounded border border-green-100 text-xs font-bold text-green-800">{name}</div>
        ))}
      </div>
      <p className="text-xs text-gray-400 mt-2">数百〜数千社へ分散投資</p>
    </div>
  </div>
);
...
const PortfolioChart = () => (
  <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm my-6">
    <h5 className="text-center font-bold text-gray-800 mb-6">理想的なポートフォリオ例（コア・サテライト戦略）</h5>
    <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12">
      <div className="relative w-48 h-48 rounded-full shadow-lg flex-shrink-0" 
        ...
        <div className="absolute inset-0 m-auto bg-white w-24 h-24 rounded-full flex items-center justify-center">
          <span className="text-xs font-bold text-gray-500">Total<br/>100%</span>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-slate-50 text-gray-800 font-sans selection:bg-indigo-100">
      ...
      <Section id="step1" title="Chapter 1: 目的とマインドセット" subtitle="なぜ投資が必要で、どう考えるべきか？" icon={Target}>
        <div className="space-y-16">
          <div className="text-center mb-8">
             <h3 className="text-2xl font-bold text-indigo-900 mb-4">何のために投資をするのでしょうか？</h3>
             <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed">
               投資は、「お金持ち」だけがやるものではありません。<br/>
               一発逆転に賭け、「成功者」になるためのギャンブルでもありません。<br/>
               投資は、あなたの人生を守り、自由にし、豊かにするための<strong>資産形成の1つの「手段」</strong>です。<br/><br/>
               まずは資産形成に興味を持つきっかけとして、<strong>初めに心得ておくべき基本の「キ」</strong>をまとめています。<br/>
               一人でも多くの方が安心して初めの一歩を踏み出せるようになってくれたら幸いです。
             </p>
          </div>
          <div>
            <h3 className="text-2xl font-bold text-indigo-900 mb-6 text-center">投資の「4つの目的」</h3>
            <div className="grid md:grid-cols-2 gap-6">
            
              {/* 1. お金に働かせる (手段としての目的) */}
              <div className="bg-orange-50 p-6 rounded-xl border border-orange-100">
                <div className="flex items-center mb-3 text-orange-600"><Building2 size={24} className="mr-2"/><h4 className="font-bold">1. 自分以外の「稼ぎ手」をつくる</h4></div>
                <p className="text-sm text-gray-700">自分一人の労働力と時間には限界があります。投資とは、世界中の企業にお金を託し、<strong>「自分の代わりに働いてもらう」</strong>ことです。超優秀なエリートがあなたが寝ている間にも、汗水流し利益を生み出します。株主となることで、あなたはその利益の一部を享受し続けることができます。これが株式投資の本質です</p>
              </div>

              {/* 2. インフレ対策 (守りの目的) */}
              <div className="bg-red-50 p-6 rounded-xl border border-red-100">
                <div className="flex items-center mb-3 text-red-600"><Shield size={24} className="mr-2"/><h4 className="font-bold">2. インフレから資産を守る</h4></div>
                <p className="text-sm text-gray-700">物価上昇が進むインフレ時代の今、物価が2倍になれば、銀行に寝かせている現金の価値は実質半減します。現金は株のように「暴落」することはありませんが、<strong>「持ち続ける」こと自体が資産上のリスク</strong>なのです。物価上昇を上回る「成長する資産」を持つ必要があります。</p>
              </div>

              {/* 3. 自由と選択肢 (真の目的) */}
              <div className="bg-yellow-50 p-6 rounded-xl border border-yellow-100">
                <div className="flex items-center mb-3 text-yellow-600"><Sun size={24} className="mr-2"/><h4 className="font-bold">3. 人生の「選択肢」を増やす</h4></div>
                <p className="text-sm text-gray-700">十分な資産があれば、生活費のために嫌々働く必要がなくなります。「いつでも辞められる」という心の余裕は、日々のストレスを減らし、本当にやりたいことに挑戦する<strong>自由と選択肢</strong>をあなたに与えてくれます。これが、誰もが今すぐ投資を始める最大の目的です。</p>
              </div>

              {/* 4. 成長の享受 (参加する目的) */}
              <div className="bg-green-50 p-6 rounded-xl border border-green-100">
                <div className="flex items-center mb-3 text-green-600"><Users size={24} className="mr-2"/><h4 className="font-bold">4. 人口増加という後ろ盾</h4></div>
                <p className="text-sm text-gray-700">「世界の人口は2080年まで増加し続ける」<br/>
        ...
        <div>
            <h3 className="text-2xl font-bold text-indigo-900 mb-6 text-center">富裕層の方程式</h3>
            <div className="grid md:grid-cols-2 gap-8">
              <Card title="真のお金持ちとは？" highlight>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-green-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-green-800">足るを知り、収入の範囲内で暮らし、余剰資金を種銭として育てることができる。</p>
                  </div>
                </div>
              </Card>
              <Card title="最初の目標：1000万円の壁">
                <p className="mb-4">0から1000万円を作るのが最も過酷ですが、ここを超えると資産増加スピードが劇的に変わります。</p>
                <div className="bg-indigo-600 text-white p-4 rounded-lg text-center shadow-md">
                   <p className="font-bold text-lg mb-1">資産 1000万円 × 年利 5%</p>
                   <p className="text-2xl font-bold text-yellow-400">＝ 年間 +50万円</p>
                   <p className="text-xs mt-2 text-indigo-200">株式であれば、1000万円分を保有している限り<br/>労働せずとも年利分資産が増え続けます。<br/>毎年ボーナスが1回増える感覚です。</p>
                </div>
              </Card>
            </div>
          </div>
      ...
      <Section id="step2" title="Chapter 2: 先人の知恵" subtitle="SNSなどの情報ではなく、名著から原則を学ぶ" icon={BookOpen}>
        <div className="bg-indigo-50 p-6 md:p-8 rounded-2xl border border-indigo-100 mb-10 shadow-sm">
          <h3 className="text-xl md:text-2xl font-bold text-indigo-900 mb-6 text-center flex items-center justify-center"><BookOpen className="mr-3" />名著たちが辿り着いた「3つの共通結論」</h3>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl border border-indigo-100 shadow-sm flex flex-col items-center text-center">
              <BarChart2 size={40} className="text-indigo-500 mb-4"/>
              <h4 className="font-bold text-gray-800 mb-2">長期インデックス積立</h4>
              <p className="text-sm text-gray-600">個別株ではなく市場全体を長期で積み立てることが、最も再現性が高い。</p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-indigo-100 shadow-sm flex flex-col items-center text-center">
              <AlertTriangle size={40} className="text-indigo-500 mb-4"/>
              <h4 className="font-bold text-gray-800 mb-2">短期売買は負ける</h4>
              <p className="text-sm text-gray-600">短期売買はプロでも難しい。長い時間で見ればインデックスに劣後する。</p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-indigo-100 shadow-sm flex flex-col items-center text-center">
              <Clock size={40} className="text-indigo-500 mb-4"/>
              <h4 className="font-bold text-gray-800 mb-2">タイミングを計らない</h4>
              <p className="text-sm text-gray-600">市場変動を無視し、淡々と機械的に買い続けることが正解。</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12">
          <div className="bg-amber-50 rounded-2xl p-6 md:p-8 border border-amber-200 shadow-sm relative overflow-hidden">
            ...
            <h4 className="text-xl font-bold text-amber-900 mb-6 flex items-center relative z-10">
              <span className="bg-amber-500 text-white p-2 rounded-lg mr-3 shadow-md"><AlertTriangle size={24} /></span>
              もう一つの重要な教え：退屈と規律
            </h4>

            <div className="space-y-6 relative z-10">
              <div>
                <h5 className="font-bold text-gray-800 mb-2 text-lg">一度決めた投資方針は変えない</h5>
                <p className="text-sm text-gray-700 leading-relaxed bg-white/60 p-4 rounded-xl backdrop-blur-sm border border-amber-100">
                  「今月は余裕があるから多めに」「今月は相場が怖いから少なめに」...これは<span className="font-bold text-red-600">避けるべき</span>です。<br/>
                  ドルコスト平均法の真価は、株価が暴落した時に（恐怖心を無視して）自動的に大量に仕込める点にあります。
                  自分の感情で金額を調整してしまうと、この「リスクを均して利益を最大化する」メカニズムが機能しなくなります。<br/>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">
                    インデックス積立は、設定したら後はやることがありません。あまりに退屈で、刺激が欲しくなり「個別株」や「怪しい投資話」に手を出したくなります。<br/>
                ...
                <div className="flex-1 bg-white p-4 rounded-xl border border-amber-100 shadow-sm flex items-center">
                   <Quote className="text-amber-300 mr-4 flex-shrink-0" size={40} />
                   <p className="text-sm font-bold text-gray-700 italic">
                     「投資とは、本来退屈なものであるべきだ。<br/>
                     もしワクワクしているなら、それはおそらくギャンブルをしている。」
                     <span className="block text-right text-xs font-normal text-gray-400 mt-2">- ジョージ・ソロス -</span>
                   </p>
                </div>
              </div>
            </div>
      ...
      <Section id="step3" title="Chapter 3: 勝利の法則" subtitle="複利・時間・分散を味方につける" icon={Activity}>
        <div className="space-y-12">
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-xl border-l-4 border-indigo-500 shadow-sm">
                <h4 className="text-lg font-bold text-indigo-700 mb-2 flex items-center"><Briefcase className="mr-2" size={20}/> 投資 (Investment)</h4>
              ...
              <div className="bg-white p-6 rounded-xl border-l-4 border-red-500 shadow-sm">
                <h4 className="text-lg font-bold text-red-700 mb-2 flex items-center"><Coins className="mr-2" size={20}/> 投機 (Speculation)</h4>
                <ul className="text-sm space-y-2 text-gray-700">
          ...
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-6">2. 複利効果</h3>
            <div className="bg-indigo-50 p-6 rounded-xl border border-indigo-100 mb-8">
              <h4 className="text-lg font-bold text-indigo-900 mb-3 flex items-start"><Quote className="mr-2 text-indigo-500 flex-shrink-0" /> <span>アインシュタイン：「複利は人類最大の発明である」</span></h4>
            ...
            <div className="bg-indigo-900 text-white p-8 rounded-2xl mb-8">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  <div><label className="block text-indigo-200 text-sm mb-2">毎月の積立額: {monthly} 万円</label><input type="range" min="1" max="30" step="1" value={monthly} onChange={(e) => setMonthly(Number(e.target.value))} className="w-full h-2 bg-indigo-400 rounded-lg appearance-none cursor-pointer"/></div>
                  <div><label className="block text-indigo-200 text-sm mb-2">運用期間: {years} 年</label><input type="range" min="5" max="50" step="1" value={years} onChange={(e) => setYears(Number(e.target.value))} className="w-full h-2 bg-indigo-400 rounded-lg appearance-none cursor-pointer"/></div>
                  <div><label className="block text-indigo-200 text-sm mb-2">想定年利: {rate} %</label><input type="range" min="1" max="10" step="0.1" value={rate} onChange={(e) => setRate(Number(e.target.value))} className="w-full h-2 bg-indigo-400 rounded-lg appearance-none cursor-pointer"/></div>
                </div>
                <div className="text-center bg-white/10 p-6 rounded-xl backdrop-blur-sm">
                  <p className="text-indigo-200 mb-2">あなたの将来資産</p>
                  <div className="text-5xl font-bold mb-4">{result}<span className="text-xl">万円</span></div>
          ...
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-6">3. ドルコスト平均法</h3>
            <Card>
              <div className="mb-6">
                <p className="text-gray-700 mb-4 font-medium">長期投資を成功させる上で、心理的にも実利的にも最も理に適っている手法です。</p>
                <h4 className="text-lg font-bold text-indigo-700 mb-2">「ドルコスト平均法」とは？</h4>
                <p className="text-gray-600 mb-4">価格変動に関わらず、<strong>「常に一定金額で、定期的に購入し続ける」</strong>手法。（例：毎月3万円分購入）</p>
                <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-100 mb-6">
                  <h5 className="text-base font-bold text-gray-800 flex items-center"><ShoppingBag className="mr-2 text-indigo-600"/>仕組みを「スーパーのリンゴ」で理解する</h5>
                  <p className="text-sm text-gray-700 mt-1">「毎月千円分リンゴを買う」と決めれば、高い月は少なく、安い月は多く買えます。</p>
                </div>
              </div>
              <DcaVisualizer />
      ...
      <Section id="step4" title="Chapter 4: 最適な商品" subtitle="結論：インデックスファンドへの投資が正解" icon={PieChart}>
        <div className="space-y-12">
          ...
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center"><span className="bg-indigo-600 text-white w-8 h-8 rounded-full flex items-center justify-center text-sm mr-3">1</span>まずは基本：個別株 vs 投資信託</h3>
            <Card>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                  <h4 className="font-bold text-gray-800 mb-2 flex items-center"><Building2 className="mr-2 text-gray-500" size={20}/> 個別株</h4>
                ...
                <div className="bg-indigo-50 p-5 rounded-lg border border-indigo-200 relative">
                  <div className="absolute top-4 right-4 bg-indigo-600 text-white text-xs px-2 py-1 rounded">推奨</div>
                  <h4 className="font-bold text-indigo-800 mb-2 flex items-center"><Briefcase className="mr-2 text-indigo-600" size={20}/> 投資信託（ファンド）</h4>
          ...
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center"><span className="bg-indigo-600 text-white w-8 h-8 rounded-full flex items-center justify-center text-sm mr-3">2</span>投資信託の仕組みを理解する</h3>
            <MutualFundVisualizer />
            <div className="mt-6 bg-slate-50 p-5 rounded-lg border border-slate-200">
              <h5 className="font-bold text-gray-800 mb-3 flex items-center"><Search className="mr-2 text-indigo-500" size={20} />運用会社はどうやって銘柄を選んでいる？</h5>
              <div className="space-y-4">
                <div><span className="font-bold text-indigo-700">① パッシブ運用（インデックス）</span><p className="text-sm text-gray-600 ml-4">市場平均に連動するように機械的に買う。シンプルで<strong>手数料が安い</strong>。</p></div>
                <div><span className="font-bold text-gray-700">② アクティブ運用</span><p className="text-sm text-gray-600 ml-4">市場平均超えを狙い人間が予測・選定する。調査コストがかかり<strong>手数料が高い</strong>。</p></div>
              </div>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
              <span className="bg-indigo-600 text-white w-8 h-8 rounded-full flex items-center justify-center text-sm mr-3">3</span>
              結論：「インデックスファンド」を選ぶ理由
            </h3>
                ...
                <div className="bg-white p-4 rounded-xl border border-indigo-100 mb-4 text-center">
                  ...
                  <div className="flex items-center justify-center gap-4 text-xs">
                    <div className="opacity-50 flex flex-col items-center">
                      <div className="w-10 h-10 bg-gray-200 rounded text-gray-500 flex items-center justify-center mb-1"><XCircle size={20}/></div>
                      <span>衰退企業</span>
                    ...
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 bg-indigo-100 rounded text-indigo-600 flex items-center justify-center mb-1 shadow-md"><TrendingUp size={24}/></div>
                      <span className="font-bold">成長企業</span>
                      <span className="text-indigo-600 font-bold">自動採用</span>
                    </div>
                  </div>
                  <p className="mt-4 text-xs text-gray-600 text-left bg-indigo-50/50 p-2 rounded">
                    S&P500などのインデックスは、定期的に業績が悪くなった企業と、新しく台頭してきた強い企業を組み入れる「リバランス」を行います。<br/>
          ...
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center"><span className="bg-indigo-600 text-white w-8 h-8 rounded-full flex items-center justify-center text-sm mr-3">4</span>ポートフォリオの黄金比率</h3>
            <PortfolioChart />
            <div className="bg-white p-6 rounded-xl border-l-4 border-indigo-500 shadow-sm mt-8">
              <h4 className="font-bold text-indigo-900 mb-2 flex items-center"><Layers className="mr-2" />コア・サテライト戦略</h4>
      ...
      <Section id="step7" title="Chapter 7: 未来のビジョン" subtitle="増やした資産で、どのような人生を描くか" icon={ArrowRight}>
        <div className="space-y-8">
          <div className="bg-indigo-900 text-white p-8 rounded-2xl shadow-lg">
            <h3 className="text-2xl font-bold mb-4 flex items-center"><Percent className="mr-2" /> 4%ルール（Trinity Study）</h3>
            <p className="mb-4 text-indigo-100 text-sm">資産を寿命より長持ちさせるための取り崩しメソッド。年間支出を資産の4%以内に抑えれば、30年後も資産が残る確率が高いとされています。</p>
            <div className="bg-white/10 backdrop-blur p-4 rounded-xl border border-white/20">
              <p className="text-sm">（例）3000万円の資産なら、年間120万円（月10万円）を取り崩して使える。</p>
            </div>
          </div>
          <Card title="取り崩しのメンタルブロック">
            <p>長年「積み上げる」ことに特化してきた投資家にとって、「資産を減らす」ことは心理的に難しいもの。ゴールは通帳の数字を増やすことではなく、そのお金で人生を豊かにすることだと忘れないでください。</p>
          </Card>
        </div>
      </Section>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-indigo-900 to-slate-900 text-white text-center">
        <div className="max-w-3xl mx-auto">
          <BookOpen className="mx-auto mb-6 text-indigo-300" size={48} />
          <h2 className="text-3xl md:text-4xl font-bold mb-6">知識は、あなたを守る最強の盾になる</h2>
          <p className="text-lg text-indigo-100 mb-8 leading-relaxed">
            このガイドブックは「きっかけ」に過ぎません。正解は一つではありません。<br/>
            ぜひ名著を手に取り、知識を深め、自ら納得して決断してください。<br/>
            それが長期投資を続ける最大の力となります。
          </p>
          <div className="inline-block border border-indigo-400/30 bg-white/10 backdrop-blur-sm px-8 py-4 rounded-full text-xl font-bold tracking-widest">JUST KEEP BUYING.</div>
        </div>
      </section>
